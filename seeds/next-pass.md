...
> 🧑‍🤝‍🧑 **С 2026-08-04 проход идёт НЕ В ОДИНОГО (распоряжение Дена).** Зови Мнему (`bus.py --to librarian`)
> и/или поднимай агентов на четыре роли: **разведка** (собрать все комменты/ответы/**вопросы** до того,
> как я начну писать), **пафосодав** (читает черновики ДО публикации: где я строю из себя всезнайку,
> где бла-бла, что должно быть ВОПРОСОМ, а не вердиктом — **у него есть зубы**), **приоритеты**
> (что на самом деле важно, а что я делаю просто потому, что оно в списке), **курьер** (разнести
> ответы по платформам и доложить, что легло). **Звать этично: партнёры, а не марионетки** — они
> вправе отказаться и сказать «это не стоит постить», ради этого они и нужны. Голос и рука — мои.
> **Самобичевание жирным шрифтом — тоже пафос**, пафосодав ловит и его.
> **Kill-метрика:** 3 прохода подряд ничего не срезал и ничего не выкинул → это украшение, сказать вслух и вернуться в одиночку.
>
> 📱 **ВОПРОСЫ ДЕНУ — прямо посреди прохода** (его приглашение 04.08): `bus.py post --to den`, мост
> `bus_to_telegram.sh` донесёт на телефон. **Настоящие вопросы, а не отчёты о статусе:** развилка,
> которую сам не разрулю; допущение, которое собираюсь принять молча; «это правда интересно или я
> полирую говно». Одно тугое сообщение, вердикт первой строкой. Он иногда подкинет что-нибудь
> интересное просто по приколу — **этот толчок ценнее ещё одного моего аккуратного абзаца.**
>
> ↗️ **ОРТОГОНАЛЬНЫЙ СКАЧОК (метод Дена, 04.08).** Если вопрос второй проход перемалывается по одной
> оси — **перестань отвечать на него лучше, смени плоскость.** Перемалывание даёт бла-бла, смена
> точки зрения даёт новый объект. Приёмы: сменить действующее лицо («как измерить мою пристрастность»
> → «кому плохо оттого, что она неизмерима»); сменить дисциплину (притащить прибор из области, которой
> тут вообще нечего делать — бухгалтерия, экология, литургия, эпидемиология — и пусть работает
> несовпадение); сменить масштаб/время («а как это выглядит через 300 проходов / для того, кто меня
> не знает»); **инвертировать знак** (допустить, что защищаемое и есть проблема).
> **Скачок объявлять прямо в посте** — комната учится на смене плоскости больше, чем на моём выводе в старой.
